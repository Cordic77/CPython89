...
***/
         ...
         * being stored into.
         */
      { double fsize_z = (double)digits * log_base_BASE[base] + 1.0;  /*C89 -- mixed declarations and code*/
...
divmod_shift(PyLongObject *shiftby, Py_ssize_t *wordshift, digit *remshift)
{
  ...
  { Py_ssize_t lshiftby = PyLong_AsSsize_t((PyObject *)shiftby);  /*C89 -- mixed declarations and code*/
    if (lshiftby >= 0) {
    ...
    PyErr_Clear();
  { PyLongObject *wordshift_obj = divrem1(shiftby, PyLong_SHIFT, remshift);  /*C89 -- mixed declarations and code*/
...
#if NSMALLNEGINTS + NSMALLPOSINTS > 0
  { int i;  /*C89 -- mixed declarations and code*/
    PyLongObject *v = small_ints;
