...
dump_counts(FILE* f)
{
  ...
  { PyTypeObject *tp;  /*C89 -- mixed declarations and code*/
...
_PyObject_IsFreed(PyObject *op)
{
  ...
  { int freed = _PyMem_IsFreed(&op->ob_type, sizeof(op->ob_type));  /*C89 -- mixed declarations and code*/
...
_PyObject_Dump(PyObject* op)
{
  ...
  { PyGILState_STATE gil;  /*C89 -- mixed declarations and code*/
