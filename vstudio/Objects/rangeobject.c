...
#else
        NULL,                   /* tp_as_number -- initialized in ‘init_PyRange_Type()’ */
#endif
...
#if !defined(ISO_C99) || (ISO_C99 == 1)  /*C89 -- designated initializers aren't supported*/
#define init_PyRange_Type()
#else
static inline void init_PyRange_Type(void)
{
  if (PyRange_Type.tp_as_number == NULL)
  {
    range_as_number.nb_bool = (inquiry)range_bool;
    PyRange_Type.tp_as_number = &range_as_number;
  }
}
#endif
