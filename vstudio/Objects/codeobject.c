...
code_dealloc(PyCodeObject *co)
{
    if (co->co_extra != NULL) {
      ...
      { Py_ssize_t i;
        for (/*Py_ssize_t*/ i = 0; i < co_extra->ce_size; i++) {  /*C89 -- mixed declarations and code*/
...
_PyCode_GetExtra(PyObject *code, Py_ssize_t index, void **extra)
{
  ...
  { PyCodeObject *o = (PyCodeObject*) code;  /*C89 -- mixed declarations and code*/
...
_PyCode_SetExtra(PyObject *code, Py_ssize_t index, void *extra)
{
  ...
  { PyCodeObject *o = (PyCodeObject*) code;  /*C89 -- mixed declarations and code*/
    ...
    if (co_extra == NULL) {
      ...
      { Py_ssize_t i;
        for (/*Py_ssize_t*/ i = co_extra->ce_size; i < co_extra->ce_size; i++) {  /*C89 -- mixed declarations and code*/
            co_extra->ce_extras[i] = NULL;
        }
      }
    }
