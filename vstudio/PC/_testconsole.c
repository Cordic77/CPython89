...
/*[clinic end generated code: output=48f9563db34aedb3 input=4c774f2d05770bc6]*/
{
  ...
  { const wchar_t *p = (const wchar_t *)PyBytes_AS_STRING(s);  /*C89 -- mixed declarations and code*/
  ...
  { HANDLE hInput = ((winconsoleio*)file)->handle;  /*C89 -- mixed declarations and code*/
    DWORD total = 0;
    while (total < size) {
        DWORD wrote;
