                        ...
                        PyObject *kwnames)
{
    ...
    if (cell != NULL) {
      ...
      { PyObject *margs[3] = {name, bases, ns};  /*C89 -- mixed declarations and code*/
...
builtin_breakpoint(PyObject *self, PyObject *const *args, Py_ssize_t nargs, PyObject *keywords)
{
    ...
    Py_INCREF(hook);
  { PyObject *retval = _PyObject_FastCallKeywords(hook, args, nargs, keywords);  /*C89 -- mixed declarations and code*/
    Py_DECREF(hook);
    return retval;
  }
}
