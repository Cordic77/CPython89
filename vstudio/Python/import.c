...
/*[clinic end generated code: output=ace7ff22271e6f39 input=37f966f890384e47]*/
{
  ...
  { PyObject *modules = NULL;  /*C89 -- mixed declarations and code*/
...
resolve_name(PyObject *name, PyObject *globals, int level)
{
    ...
    if (package != NULL) {
        ...
        if (_PyDict_GetItemId(globals, &PyId___path__) == NULL) {
          ...
          { PyObject *substr = PyUnicode_Substring(package, 0, dot);  /*C89 -- mixed declarations and code*/
            if (substr == NULL) {
                goto error;
            }
...
PyInit__imp(void)
{
    ...
    if (d == NULL)
        goto failure;
  { PyObject *pyc_mode = PyUnicode_FromString(_Py_CheckHashBasedPycsMode);  /*C89 -- mixed declarations and code*/
    if (pyc_mode == NULL) {
        goto failure;
    }
