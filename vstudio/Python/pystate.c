...
_PyRuntimeState_Init_impl(_PyRuntimeState *runtime)
{
  ...
  { Py_tss_t initial = Py_tss_NEEDS_INIT;  /*C89 -- mixed declarations and code*/
...
_PyRuntimeState_Init(_PyRuntimeState *runtime)
{
  ...
  { _PyInitError err = _PyRuntimeState_Init_impl(runtime);  /*C89 -- mixed declarations and code*/
...
_PyInterpreterState_LookUpID(PY_INT64_T requested_id)
{
  ...
  { PyInterpreterState *interp = PyInterpreterState_Head();  /*C89 -- mixed declarations and code*/
    while (interp != NULL) {
...
_PyInterpreterState_IDDecref(PyInterpreterState *interp)
{
    ...
    interp->id_refcount -= 1;
  { int64_t refcount = interp->id_refcount;  /*C89 -- mixed declarations and code*/
    PyThread_release_lock(interp->id_mutex);
...
_PyGILState_Reinit(void)
{
  ...
  { PyThreadState *tstate = PyGILState_GetThisThreadState();  /*C89 -- mixed declarations and code*/
    PyThread_tss_delete(&_PyRuntime.gilstate.autoTSSkey);
    if (PyThread_tss_create(&_PyRuntime.gilstate.autoTSSkey) != 0) {
        Py_FatalError("Could not allocate TSS entry");
    }
