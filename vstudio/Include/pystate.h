...
#ifndef Py_PYSTATE89_H
#define Py_PYSTATE89_H
#ifdef __cplusplus
extern "C" {
#endif
...
{ _PyCoreConfig py_core_config = {0};
  ...
  return (py_core_config);
}
#define _PyCoreConfig_INIT C89_PyCoreConfig_INIT()
#endif
...
#else
static inline _PyMainInterpreterConfig C89_PyMainInterpreterConfig_INIT(void)
{ _PyMainInterpreterConfig py_maininterpreter_config = {0};
  py_maininterpreter_config.install_signal_handlers = -1;
  return (py_maininterpreter_config);
}
#define _PyMainInterpreterConfig_INIT C89_PyMainInterpreterConfig_INIT()
#endif
