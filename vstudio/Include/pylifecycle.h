...
#ifndef Py_PYLIFECYCLE89_H
#define Py_PYLIFECYCLE89_H
#ifdef __cplusplus
extern "C" {
#endif
...
#else
static inline _PyInitError C89_Py_INIT_OK(void)
{ static _PyInitError init_ok = {NULL, NULL, 0};
  return (init_ok);
}
#define _Py_INIT_OK() \
    C89_Py_INIT_OK()

static inline _PyInitError C89_Py_INIT_ERR(const char *py_init_get_func, const char *msg)
{ _PyInitError init_err = {py_init_get_func, msg, 0};
  return (init_err);
}
#define _Py_INIT_ERR(MSG) \
    C89_Py_INIT_ERR(_Py_INIT_GET_FUNC(), (MSG))

/* Error that can be fixed by the user like invalid input parameter.
   Don't abort() the process on such error. */
static inline _PyInitError C89_Py_INIT_USER_ERR(const char *py_init_get_func, const char *msg)
{ _PyInitError init_user_err = {py_init_get_func, msg, 1};
  return (init_user_err);
}
#define _Py_INIT_USER_ERR(MSG) \
    C89_Py_INIT_USER_ERR(_Py_INIT_GET_FUNC(), (MSG))
#endif
