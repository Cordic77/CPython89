...
validate_node(node *tree)
{
    ...
    for (pos = 0; pos < nch; ++pos) {
        ...
        for (arc = 0; arc < dfa_state->s_narcs; ++arc) {
          ...
          { const char *label_str = _PyParser_Grammar.g_ll.ll_label[a_label].lb_str;  /*C89 -- mixed declarations and code*/
        ...
        /* What would this state have accepted? */
        {
          ...
          { int next_type = _PyParser_Grammar.g_ll.ll_label[a_label].lb_type;  /*C89 -- mixed declarations and code*/
