...
#if defined(_MSC_VER) && _MSC_VER >= 1800  /*VS9COMPAT: see ‘10.0.15063.0\um\VersionHelpers.h’*/
...
remove_unusable_flags(PyObject *m)
{
  ...
  { int i;
    for (/*int*/ i=0; i<sizeof(win_runtime_flags)/sizeof(FlagRuntimeInfo); i++) {  /*C89 -- mixed declarations and code*/
...
sock_settimeout(PySocketSockObject *s, PyObject *arg)
{
  ...
  { int block = timeout < 0;  /*C89 -- mixed declarations and code*/
