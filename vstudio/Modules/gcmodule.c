...
#define _GEN_HEAD(n) (&state->generations[n].head)
  { struct gc_generation generations[NUM_GENERATIONS] = {  /*C89 -- mixed declarations and code*/
  ...
  { struct gc_generation permanent_generation = {  /*C89 -- mixed declarations and code*/
