...
win32_wchdir(LPCWSTR path)
{
  ...
  { int is_unc_like_path = (wcsncmp(new_path, L"\\\\", 2) == 0 ||
                            wcsncmp(new_path, L"//", 2) == 0);  /*C89 -- mixed declarations and code*/
    if (!is_unc_like_path) {
        env[1] = new_path[0];
...
/*[clinic end generated code: output=621a3c79bc29ebfa input=2b6b6c7cbad5fb84]*/
{
    ...
    while (1) {
      ...
      { wchar_t *tmp;  /*C89 -- mixed declarations and code*/
...
/*[clinic end generated code: output=d29a567d6b2327d2 input=ba586581c2e6105f]*/
{
  ...
  { PyObject *unicode = PyUnicode_FromFormat("%U=%U", name, value);  /*C89 -- mixed declarations and code*/
    if (unicode == NULL) {
        return NULL;
    }
...
/*[clinic end generated code: output=5fc29463c3936a9c input=e7c8f4ba6dbbadd3]*/
{
  ...
  { static DWORD(CALLBACK *_GetMaximumProcessorCount)(WORD) = NULL;  /*C89 -- mixed declarations and code*/
    *(FARPROC*)&_GetMaximumProcessorCount = GetProcAddress(hKernel32,
        "GetMaximumProcessorCount");
    if (_GetMaximumProcessorCount != NULL) {
        #ifndef ALL_PROCESSOR_GROUPS
        #define ALL_PROCESSOR_GROUPS        0xffff  /*VS9COMPAT -- see ‘WinNT.h’*/
        #endif
...
DirEntry_fetch_stat(DirEntry *self, int follow_symlinks)
{
    ...
    if (!PyUnicode_FSDecoder(self->path, &ub))
        return NULL;
  { const wchar_t *path = PyUnicode_AsUnicode(ub);  /*C89 -- mixed declarations and code*/
#else /* POSIX */
