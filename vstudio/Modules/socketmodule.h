...
#else /* MS_WINDOWS */
# include <winsock2.h>
# if !defined(NTDDI_VISTA) || (NTDDI_VISTA == 0)
#   error "Python 3.5+ requires NTDDI_VISTA; please set this constant in your sdkddkver.h!"
# endif
# ifndef EISCONN  /*VS9COMPAT -- commented out in Windows headers*/
