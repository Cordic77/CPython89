...
locale_decode_monetary(PyObject *dict, struct lconv *lc)
{
  ...
  { char *oldloc = NULL, *loc = NULL;  /*C89 -- mixed declarations and code*/
    if (change_locale) {
  ...
  { int res = -1;  /*C89 -- mixed declarations and code*/
...
#define RESULT_INT(i)\
  ...
  { PyObject *decimal_point, *thousands_sep;  /*C89 -- mixed declarations and code*/
    const char *grouping;
