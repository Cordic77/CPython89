...
_PyTime_GetProcessTimeWithInfo(_PyTime_t *tp, _Py_clock_info_t *info)
{
    ...
    *tp = t;
    ...
    if (getrusage(RUSAGE_SELF, &ru) == 0) {
      ...
      { _PyTime_t total = utime + utime;  /*C89 -- mixed declarations and code*/
        *tp = total;
      }
        return 0;
    }
    ...
    if (times(&t) != (clock_t)-1) {
        ...
        if (ticks_per_second != -1) {
          ...
          { _PyTime_t total;  /*C89 -- mixed declarations and code*/
...
#define MAX_TIMEZONE (48 * 3600)
      ...
      { int janzone = (int)janzone_t;  /*C89 -- mixed declarations and code*/
