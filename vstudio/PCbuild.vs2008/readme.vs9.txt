...
_sqlite3
    Wraps SQLite 3.7.4, which is currently built by sqlite3.VS2008.vcproj (see below).
_tkinter
    Wraps the Tk windowing system.  Unlike _sqlite3, there's no
    corresponding tcltk.VS2008.vcproj-type project that builds Tcl/Tk from vcproj's
...
pcbuild.sln as custom .VS2008.vcproj files, just as we've recently done with the
sqlite3.VS2008.vcproj file, which will remove the need for Tcl/Tk to be built
...
(*.VS2008.vsprops). The properties can be viewed and altered in the Property
